...
?>
    ...
    <div class="home_back--inner">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/home/aurveda_doctor_back.webp" alt="" />
    </div>
    <div class="home_back--inner-mob">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/home/aurveda_doctor_back_mob.webp" alt="" />
    </div>
        ...
        <div class="doctor__info">
			<?$APPLICATION->IncludeComponent(
              ...
              array(
                ...
                "EDIT_TEMPLATE" => "",
                "COMPONENT_TEMPLATE" => ".default",
                "PATH" => "/ru/include_areas/vinod_srivastrav.php"
              ),
              false
            );?>
          ...
          <!-- <div class="doctor__info_title">
            ...
            <div class="doctor__info_title-img">
              <img src="<?=SITE_TEMPLATE_PATH?>/images/home/doctor_block_img.webp" alt="" />
            </div>
          </div>
          <div class="doctor__info_description">
            ...
            <div class="doctor__img--mob">
              <img src="<?=SITE_TEMPLATE_PATH?>/images/home/doctor.webp" alt="" />
            </div>
