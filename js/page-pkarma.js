  ...
  function resize() {
    ...
    if (btns && contraindications) {
      if (width < 768) {
        ...
        arrowPrev.className = 'procedures-navigation-prev';
        arrowPrev.innerHTML = `
        ...
        arrowNext.className = 'procedures-navigation-next';
        arrowNext.innerHTML = `
        <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const proceduresSlider = new Swiper('.procedures__slider', {
          ...
          navigation: {
            nextEl: '.procedures-navigation-next',
            prevEl: '.procedures-navigation-prev',
          },
        });
      } else {
