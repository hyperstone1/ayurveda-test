document.addEventListener('DOMContentLoaded', function () {
  ...
  function addPaginationArrows() {
    ...
    let control = document.querySelector('.list__control-nav');
    let controlNext = document.querySelector('.list__control-next');
    let slides = document.querySelectorAll('.list__item');
    if (windowWidth < 768 && control && !controlNext) {
      ...
      packagesList = new Swiper('.packages__list', {
        slidesPerView: 'auto',
        spaceBetween: 20,
        pagination: {
        ...
        navigation: {
          nextEl: '.list__control-next',
          prevEl: '.list__control-prev',
        },
      });
      var prevButton = document.createElement('div');
      prevButton.className = 'list__control-prev';
      ...
      nextButton.className = 'list__control-next';
      ...
      packagesList.navigation.init();
      packagesList.navigation.update();
    } else {
      if (packagesList) {
